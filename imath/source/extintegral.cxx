...
/*316*/ { pow(cosax, 4), numeric(3, 8) * x + 1 / (4 * a) * Functionmanager::create_hard("sin", {2 * a * x}) + Functionmanager::create_hard("sin", { 4 * a * x}) / (32 * a) },
...
/*344*/ { pow(1 + pow(cosax, 2), -1), 1 / (2 * GiNaC::sqrt(ex(2)) * a)* Functionmanager::create_hard("arcsin", {(1 - 3 * pow(cosax, 2)) / (1 + pow(cosax, 2))}) },
