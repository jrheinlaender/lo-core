...
void iFormulaLine::setFormula(const OUString& f)
{
    _formulaParts = { f };
    error
        = no_error; // Assume the error was corrected (if not, it will come up again in the recalculation)
}
...
iFormulaNodeExpression::iFormulaNodeExpression(const GiNaC::unitvec&& unitConversions,
...
// NodeText
iFormulaNodeText::iFormulaNodeText(const GiNaC::unitvec&& unitConversions,
...
// Node Ex
iFormulaNodeEx::iFormulaNodeEx(const GiNaC::unitvec&& unitConversions,
                               std::shared_ptr<optionmap> g_options, optionmap&& l_options,
...
// Node Value
iFormulaNodeValue::iFormulaNodeValue(const GiNaC::unitvec&& unitConversions,
                                     std::shared_ptr<optionmap> g_options, optionmap&& l_options,
                                     std::vector<OUString>&& formulaParts, const OUString& label,
...
// Node Printval
iFormulaNodePrintval::iFormulaNodePrintval(const GiNaC::unitvec&& unitConversions,
                                           std::shared_ptr<optionmap> g_options,
                                           optionmap&& l_options,
                                           std::vector<OUString>&& formulaParts,
                                           const OUString& label, const expression& expr,
...
iFormulaNodeExplainval::iFormulaNodeExplainval(
    const GiNaC::unitvec&& unitConversions, std::shared_ptr<optionmap> g_options,
    optionmap&& l_options, std::vector<OUString>&& formulaParts, const OUString& label,
    const expression& expr, const bool hide, const expression& lh, const expression& definition,
    exhashmap<ex>&& symbols)
    : iFormulaNodeValue(std::move(unitConversions), g_options, std::move(l_options),
                        std::move(formulaParts), label, expr, hide, lh)
...
// Node Eq
iFormulaNodeEq::iFormulaNodeEq(const GiNaC::unitvec&& unitConversions,
                               std::shared_ptr<optionmap> g_options, optionmap&& l_options,
                               std::vector<OUString>&& formulaParts, const OUString& label,
                               const expression& expr, const bool hide)
    : iFormulaNodeExpression(std::move(unitConversions), g_options, std::move(l_options),
...
// Node Const
iFormulaNodeConst::iFormulaNodeConst(const GiNaC::unitvec&& unitConversions,
                                     std::shared_ptr<optionmap> g_options, optionmap&& l_options,
                                     std::vector<OUString>&& formulaParts, const OUString& label,
                                     const expression& expr, const bool hide)
...
// Node Funcdef
iFormulaNodeFuncdef::iFormulaNodeFuncdef(const GiNaC::unitvec&& unitConversions,
                                         std::shared_ptr<optionmap> g_options,
                                         optionmap&& l_options,
                                         std::vector<OUString>&& formulaParts,
                                         const OUString& label, const expression& expr,
...
// Node Vectordef
iFormulaNodeVectordef::iFormulaNodeVectordef(const GiNaC::unitvec&& unitConversions,
                                             std::shared_ptr<optionmap> g_options,
                                             optionmap&& l_options,
                                             std::vector<OUString>&& formulaParts,
                                             const OUString& label, const expression& expr,
...
// Node Matrixdef
iFormulaNodeMatrixdef::iFormulaNodeMatrixdef(const GiNaC::unitvec&& unitConversions,
                                             std::shared_ptr<optionmap> g_options,
                                             optionmap&& l_options,
                                             std::vector<OUString>&& formulaParts,
                                             const OUString& label, const expression& expr,
