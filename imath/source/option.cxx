...
bool option::operator==(const option& other) const
{
    ...
    switch (type)
    {
        ...
        case t_align:
            return value.align == other.value.align;
        case t_uint:
            return value.uinteger == other.value.uinteger;
        case t_int:
            return value.integer == other.value.integer;
        case t_exvec:
            return (*value.exvec) == (*other.value.exvec);
        default:
            return false;
    }
}

bool option::operator!=(const option& other) const { return !(*this == other); }
...
void option::print(std::ostream& os) const
{
    switch (type)
    {
        ...
        case t_exvec:
            ...
            break;
        default:
            throw std::invalid_argument("Internal error: Unknown option type");
    }
}
