...
std::map<option_name, Settingsmanager::settingsdata> Settingsmanager::settings = {
    { o_autofraction,
      { t_bool, false, OU("O_Autofraction"), OU("Formatting/O_Autofraction"),
        OU("formatting_o_autofraction"), OU("autofraction"), OU("Automatic fraction sizing") } },
    { o_autotextmode,
      { t_bool, false, OU("O_Autotextmode"), OU("Formatting/O_Autotextmode"),
        OU("formatting_o_autotextmode"), OU("autotextmode"), OU("Automatic text mode") } },
    { o_basefontheight, { t_uint, false, OU(""), OU(""), OU(""), OU(""), OU("Base font height") } },
    { o_difftype,
      { // Should really be txt_Difftype
        t_str, false, OU(""), OU("Formatting/O_Difftype"), OU("formatting_o_difftype"),
        OU("difftype"), OU("Differentials notation") } },
    { o_echoformula,
      { t_bool, false, OU("O_Echoformula"), OU("Miscellaneous/O_Echoformula"),
        OU("miscellaneous_o_echoformula"), OU("echo"), OU("Echo formula") } },
    { o_eqalign,
      { t_align, false, OU("O_Autoalign"), OU("Formatting/O_Autoalign"),
        OU("formatting_o_autoalign"), OU("autoalign"), OU("Automatic aligning") } },
    { o_eqchain,
      { t_bool, false, OU("O_Autochain"), OU("Formatting/O_Autochain"),
        OU("formatting_o_autochain"), OU("autochain"), OU("Automatic chaining") } },
    { o_eqraw,
      { t_bool, true, OU("O_Autoformat"), OU("Formatting/O_Autoformat"),
        OU("formatting_o_autoformat"), OU("autoformat"), OU("Automatic formatting") } },
    { o_externaleditor,
      { t_str, false, OU("txt_Externaleditor"), OU("Editing/txt_Externaleditor"), OU(""), OU(""),
        OU("External formula editor") } },
    { o_forceautoformat,
      { t_bool, false, OU(""), OU(""), OU(""), OU(""), OU("Force automatic formatting") } },
    { o_implicitmul,
      { t_bool, false, OU("O_Implicitmul"), OU("Formatting/O_Implicitmul"),
        OU("formatting_o_implicitmul"), OU("implicitmul"), OU("Implicit multiplication") } },
    { o_eqsplit,
      { t_int, false, OU(""), OU("Formatting/I_Eqsplitpoint"), OU("formatting_i_eqsplitpoint"),
        OU("eqsplit"), OU("Equation line break point") } },
    { o_eqsplittext,
      { t_str, false, OU(""), OU("Formatting/txt_Eqsplittext"), OU("formatting_txt_eqsplittext"),
        OU("eqsplittext"), OU("Equation line break text") } },
    { o_evalf_real_roots,
      { t_bool, false, OU("O_Evalf_Real_Roots"), OU("Internal/O_Evalf_Real_Roots"),
        OU("internal_o_evalf_real_roots"), OU("realroots"), OU("Evaluate to real roots") } },
    { o_exponent,
      { t_int, false, OU("I_Exponent"), OU("Formatting/I_Exponent"), OU("formatting_i_exponent"),
        OU("exponent"), OU("Exponent") } },
    { o_fixeddigits,
      { t_bool, true, OU("O_Fixedpoint"), OU("Formatting/O_Fixedpoint"),
        OU("formatting_o_fixedpoint"), OU("fixedpoint"), OU("Fixed point notation") } },
    { o_formulafont,
      { t_str, false, OU("lst_FormulaFont"), OU("Formatting/txt_FormulaFont"),
        OU("formatting_txt_formulafont"), OU(""), OU("Formula font") } },
    { o_fractionlevel,
      { t_uint, false, OU(""), OU(""), OU(""), OU(""), OU("Fraction nesting level") } },
    { o_highsclimit,
      { t_int, false, OU("I_Highsclimit"), OU("Formatting/I_Highsclimit"),
        OU("formatting_i_highsclimit"), OU("highsclimit"), OU("Minimum positive exponent") } },
    { o_lowsclimit,
      { t_int, false, OU("I_Lowsclimit"), OU("Formatting/I_Lowsclimit"),
        OU("formatting_i_lowsclimit"), OU("lowsclimit"), OU("Maximum negative exponent") } },
    { o_minimumtextsize,
      { t_uint, false, OU("I_Minimumtextsize"), OU("Formatting/I_Minimumtextsize"),
        OU("formatting_i_minimumtextsize"), OU("minimumtextsize"), OU("Minimum text size") } },
    { o_precision,
      { t_uint, false, OU("I_Precision"), OU("Formatting/I_Precision"),
        OU("formatting_i_precision"), OU("precision"), OU("Precision") } },
    { o_showlabels,
      { t_bool, false, OU("O_ShowLabels"), OU("Formatting/O_ShowLabels"),
        OU("formatting_o_showlabels"), OU("showlabels"), OU("Show labels") } },
    { o_suppress_units,
      { t_bool, false, OU("O_Suppress_Units"), OU("Formatting/O_Suppress_Units"),
        OU("formatting_o_suppress_units"), OU("suppress_units"), OU("Suppress units") } },
    { o_underflow,
      { t_bool, false, OU("O_Underflow"), OU("Internal/O_Underflow"), OU("internal_o_underflow"),
        OU("underflow"), OU("Inhibit underflow exception") } },
    { o_unitstr,
      { t_str, false, OU("txt_Units"), OU("Formatting/txt_PreferredUnits"),
        OU("formatting_txt_preferredunits"), OU("units"), OU("Preferred units") } },
    { o_units, { t_exvec, false, OU(""), OU(""), OU(""), OU(""), OU("Preferred units") } },
    { o_vecautosize,
      { t_uint, false, OU("I_Vecautosize"), OU("Internal/O_Vecautosize"),
        OU("internal_o_vecautosize"), OU("vecautosize"), OU("Automatic vector size") } },
};
...
void Settingsmanager::removeLegacyProperties(const Reference<XPropertyContainer>& xUserPropsCont)
{
    for (const auto& srec : settings)
    {
        if (propertyIs(xUserPropsCont, srec.second.legacyPropertyName))
            ...
            MSG_INFO(1, "removeLegacyProperties: property does not exist: "
                            << STR(srec.second.legacyPropertyName) << endline);
    }
}

void Settingsmanager::migrateProperties(const Reference<XComponentContext>& mxCC,
                                        const Reference<XModel>& xModel,
                                        const Reference<XNamedGraph>& xGraph,
                                        const Reference<XPropertyContainer>& xUserPropsCont)
{
    for (const auto& srec : settings)
    {
        if (!propertyIs(xUserPropsCont, srec.second.legacyPropertyName))
        {
            MSG_INFO(1, "migrateProperties: property does not exist: "
                            << STR(srec.second.legacyPropertyName) << endline);
            continue;
        }
        ...
        switch (srec.second.otype)
        {
            ...
            case t_bool:
                object = (getBoolProperty(xUserPropsCont, srec.second.legacyPropertyName)
                              ? OU("true")
                              : OU("false"));
                break;
            case t_dbl:
                break;
            case t_uint:
                object = OUSTRINGNUMBER(
                    getPosIntProperty(xUserPropsCont, srec.second.legacyPropertyName));
                break;
            case t_int:
                object = OUSTRINGNUMBER(
                    getIntProperty(xUserPropsCont, srec.second.legacyPropertyName));
                break;
            case t_exvec:
                break;
        }
...
OUString makeOptionString(const option_type otype, const OUString& formulaOptionName,
                          const option& o, const bool invert)
{
...
OUString Settingsmanager::createOptionString(const optionmap& options)
{
    ...
    for (const auto& i : options)
    {
        ...
        {
            MSG_INFO(1, "createOptionString: Setting " << STR(s_it->second.formulaOptionName)
                                                       << " does not exist" << endline);
            continue;
        }
        result += makeOptionString(s_it->second.otype, s_it->second.formulaOptionName, i.second,
                                   s_it->second.invert);
    }
...
OUString
Settingsmanager::createOptionStringFromControls(const optionmap& options,
    ...
    for (const auto& i : options)
    {
        ...
        if (s_it == settings.end())
        {
            MSG_INFO(1, "createOptionStringFromControls: Setting "
                            << STR(s_it->second.formulaOptionName) << " does not exist" << endline);
            continue;
        }
        ...
        switch (s_it->second.otype)
        {
            ...
            case t_dbl:
                break;
            case t_align:
                o = option((getCheckBox(xControlContainer, s_it->second.controlName) == 1) ? both
                                                                                           : none);
                break;
            case t_uint:
                o = option(
                    (unsigned)getNumericFieldPosInt(xControlContainer, s_it->second.controlName));
                break;
            case t_int:
        ...
        if (i.second != o)
            result += makeOptionString(s_it->second.otype, s_it->second.formulaOptionName, o,
                                       s_it->second.invert);
    }
...
void Settingsmanager::initializeOptionmap(const Reference<XComponentContext>& mxCC,
                                          const Reference<XModel>& xModel,
                                          const Reference<XNamedGraph>& xGraph,
