...
enum symprop : std::size_t
{
    ...
    p_default
    = 5, // Used as argument to getsym() to return the variable with the property as stored in field eqrec::prop
    p_none
    = 6 // New symbol or after clear() in the compiler to show that the variable has not been used since last CLEAREQUATIONS
};
