...
public:
   ...
   */
    func(const std::string& n, const exprseq& args, const unsigned s, const bool hc,
         const exvector& v, const expression& d, const unsigned h, const std::string& pn);
    func(const std::string& n, exprseq&& args, const unsigned s, const bool hc, const exvector& v,
    ...
    void printseq(const print_context& c, const std::string& openbracket, const std::string& delim,
   ...
   */
    ...
    static const unsigned no_expand_function_definition
        = 0x8000; // Don't expand the function definition. Extends GiNaC::expand_options
...
private:
    using exprseq::
        printseq; // Shut up warning about our printseq() hiding the base classes' printseq()
};
