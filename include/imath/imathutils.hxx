...
/// remove a formula
IMATH_DLLPUBLIC void deleteFormula(const Reference<XModel>& xModel,
                                   const Reference<XComponent>& iFormula);
...
IMATH_DLLPUBLIC OUString getInterText(const Reference<XTextContent>& f1,
                                      const Reference<XTextContent>& f2);
